...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [140 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 13457792; uint32_t buffer_offset
	}, ; 137: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13628800; uint32_t buffer_offset
	}, ; 138: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2035200, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13650336; uint32_t buffer_offset
	} ; 139: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15685536, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15685536 x i8] zeroinitializer, align 1
