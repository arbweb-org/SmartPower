...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001d00, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001cff, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [954 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.90_name, ; name: libaot-System.Net.WebSockets.Client.dll.so
		ptr null; void* handle
	}, ; 42
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x1d402fb7a288110d, ; from name: aot-SmartPower.Client.so
		i64 u0x97e22595591e691c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SmartPower.Client.dll.so
		ptr null; void* handle
	}, ; 100
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.91_name, ; name: libaot-System.Net.WebSockets.dll.so
		ptr null; void* handle
	}, ; 105
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.77_name, ; name: libaot-System.IO.FileSystem.Watcher.dll.so
		ptr null; void* handle
	}, ; 128
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3133f2f94140685f, ; from name: aot-SmartPower.Client.dll.so
		i64 u0x97e22595591e691c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SmartPower.Client.dll.so
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.89_name, ; name: libaot-System.Net.WebHeaderCollection.dll.so
		ptr null; void* handle
	}, ; 220
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x4e0d5c7f4dee3a9b, ; from name: libaot-SmartPower.Client
		i64 u0x97e22595591e691c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SmartPower.Client.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x6873cb204ebcc594, ; from name: libaot-SmartPower.Client.so
		i64 u0x97e22595591e691c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SmartPower.Client.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x81896cea1b2c67fc, ; from name: aot-SmartPower.Client
		i64 u0x97e22595591e691c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SmartPower.Client.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x97e22595591e691c, ; from name: libaot-SmartPower.Client.dll.so
		i64 u0x97e22595591e691c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SmartPower.Client.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xc4dc7ab151029f1f, ; from name: SmartPower.Client.so
		i64 u0x97e22595591e691c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SmartPower.Client.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xeae68622674fb028, ; from name: SmartPower.Client.dll.so
		i64 u0x97e22595591e691c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SmartPower.Client.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xf9c6f7beaab92534, ; from name: SmartPower.Client
		i64 u0x97e22595591e691c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-SmartPower.Client.dll.so
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"org.arbweb.smartpower\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [32 x i8] c"libaot-SmartPower.Client.dll.so\00", align 16
...
@.DSOCacheEntry.77_name = private unnamed_addr constant [43 x i8] c"libaot-System.IO.FileSystem.Watcher.dll.so\00", align 16
...
@.DSOCacheEntry.89_name = private unnamed_addr constant [45 x i8] c"libaot-System.Net.WebHeaderCollection.dll.so\00", align 16
@.DSOCacheEntry.90_name = private unnamed_addr constant [43 x i8] c"libaot-System.Net.WebSockets.Client.dll.so\00", align 16
@.DSOCacheEntry.91_name = private unnamed_addr constant [36 x i8] c"libaot-System.Net.WebSockets.dll.so\00", align 16
